        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="space-y-4">
            <h3 className="font-medium text-sm flex items-center gap-2">
              ...
              Camera Giám sát (Live View)
            </h3>
            {/* Camera 1: Dùng Webcam thật để demo FaceID */}
            <CameraFeed
              useWebcam={true}
              label="CAM-01: Main Lobby"
              location="Khu vực Check-in nhận diện khuôn mặt"
              className="aspect-video shadow-xl border-primary/20"
            />
            {/* Camera 2: Ảnh tĩnh giả lập khu vực hành lang */}
            <CameraFeed
              src={cctvHallway}
              label="CAM-02: Zone B Corridor"
              location="Hành lang Kho - Phát hiện chuyển động"
